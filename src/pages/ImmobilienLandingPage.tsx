...
const ImmobilienLandingPage = () => {
  ...
  const checkQuestions = [
    {
      question: "Wie viel Zeit verbringen Sie täglich mit Routineanfragen von Mietern?",
      answers: [
  ...
  const handleAnswerSelect = (questionIndex: number, answerIndex: number) => {
    ...
    if (newAnswers.every(answer => answer !== null)) {
      const totalPoints = newAnswers.reduce((sum, answerIndex, qIndex) => 
        sum + (answerIndex !== null ? checkQuestions[qIndex].answers[answerIndex].points : 0), 0
      );
  ...
  const getCheckResultText = (score: number) => {
    if (score <= 5) return {
      ...
      description: "Ihr Digitalisierungsgrad ist noch sehr niedrig. Sie verlieren täglich wertvolle Zeit durch manuelle Prozesse.",
      color: "text-red-600",
      bgColor: "bg-red-50 border-red-200"
    };
    if (score <= 10) return {
      level: "Guter Start, aber Potenzial da",
      description: "Sie haben erste Schritte gemacht, aber es gibt noch viel Raum für Verbesserungen.",
      color: "text-orange-600",
      bgColor: "bg-orange-50 border-orange-200"
    };
    return {
      level: "Sehr gut aufgestellt",
      description: "Sie sind bereits digital gut aufgestellt, aber auch hier gibt es noch Optimierungsmöglichkeiten.",
  ...
  const problems = [
    {
      ...
      description: "150 Bewerbungen für eine Wohnung? Mit KI automatisieren Sie Absagen und Kommunikation – professionell und zeitsparend.",
      result: "Weniger Arbeitsaufwand, zufriedene Bewerber"
    },
    {
      icon: <Building2 className="w-8 h-8 text-primary" />,
      title: "Schäden automatisch erfassen",
      description: "Digitale Formulare und automatisierte Abläufe übernehmen Dokumentation, Handwerkeranfragen und Versicherungsunterlagen.",
      result: "Schnellere Reaktionszeiten, weniger Fehler"
    },
    {
      icon: <TrendingUp className="w-8 h-8 text-primary" />,
      title: "Vermietungsprozesse beschleunigen",
      description: "90% der Vermietungsprozesse laufen gleich ab. Automatisierung reduziert Leerstand und beschleunigt Neuvermietungen.",
      result: "Mehr Rendite, weniger Routinearbeit"
    },
    {
      icon: <Zap className="w-8 h-8 text-primary" />,
      title: "Anfragen automatisch beantworten",
      description: "KI beantwortet Standardfragen 24/7: Nebenkostenabrechnung, Vermietungsstand, Ansprechpartner.",
      result: "Weniger Unterbrechungen, mehr Fokus"
    },
    {
      icon: <Calendar className="w-8 h-8 text-primary" />,
      title: "Terminplanung stressfrei gestalten",
      description: "KI-gestützte Terminbuchung: Interessenten planen selbst – fehlerfrei und effizient.",
      ...
      <section className="py-12 bg-background border-b border-border">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto text-center">
            <p className="text-muted-foreground mb-8">Vertraut von führenden Hausverwaltungen</p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
                5 Probleme, die Sie <span className="bg-gradient-primary bg-clip-text text-transparent">heute</span> lösen können
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Jeden Tag verlieren Sie wertvolle Stunden durch manuelle Prozesse. 
                Hier sind die 5 häufigsten Zeitfresser – und wie Sie sie eliminieren.
              </p>
            </div>
              ...
              <Card className="md:col-span-2 lg:col-span-1 bg-gradient-primary text-white border-0">
                <CardContent className="p-8 flex flex-col justify-center h-full text-center">
                  ...
                  <p className="mb-6 opacity-90">
                    Lassen Sie uns gemeinsam Ihre größten Zeitfresser identifizieren und sofort lösbare Maßnahmen entwickeln.
                  </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Finden Sie in 2 Minuten heraus, wie viel Potenzial in Ihrer Hausverwaltung steckt
              </p>
            </div>
                    ...
                    <div key={qIndex} className="space-y-4">
                      ...
                      <div className="grid gap-3">
                        {question.answers.map((answer, aIndex) => (
                          <Button
                            key={aIndex}
                            variant={currentAnswers[qIndex] === aIndex ? "default" : "outline"}
                  ...
                  {checkResults !== null && (
                    <div className="mt-8 animate-fade-in">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className={`p-6 rounded-lg border ${result.bgColor}`}>
                            <h4 className={`text-xl font-bold mb-3 ${result.color}`}>
                            ...
                            <div className="bg-white p-6 rounded-lg border border-border">
                              ...
                              <ul className="space-y-2 text-muted-foreground mb-6">
                                <li className="flex items-center gap-2">
                                  ...
                                  Kostenlose 30-Min-Analyse Ihrer aktuellen Prozesse
                                </li>
                                <li className="flex items-center gap-2">
                                  <CheckCircle className="w-4 h-4 text-green-500" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl opacity-90">
                Buchen Sie Ihr kostenloses 30-Minuten-Erstgespräch und erhalten Sie sofort umsetzbare Lösungen
              </p>
            </div>
            ...
            <Card className="border-0 bg-white text-foreground">
              <CardContent className="p-8 lg:p-12">
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Anzahl verwaltete Einheiten</label>
                    <Input
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Ihre größte Herausforderung</label>
                    <textarea
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-4">
                      Wir melden uns innerhalb von 24 Stunden bei Ihnen. 100% unverbindlich.
                    </p>
                  </div>
                </form>
              </CardContent>
