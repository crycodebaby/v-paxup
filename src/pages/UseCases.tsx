  ...
  const useCases = [
    {
      ...
      industry: "Immobilien",
      challenge:
        "Manueller Aufwand bei Mieterverwaltung, Instandhaltung und Abrechnungen",
      solution:
        "Automatisierte Verwaltungsprozesse mit KI-gestützter Dokumentenerkennung",
      results: [
    ...
    },
    {
      ...
      industry: "Handwerk",
      challenge:
        "Papierbasierte Prozesse, ineffiziente Terminplanung und Materialbeschaffung",
      solution:
        "Digitale Auftragsabwicklung mit automatisierter Ressourcenplanung",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Terminmanagement, Patientendokumentation und Abrechnungsprozesse",
    ...
    },
    {
      ...
      industry: "Logistik",
      challenge:
        "Routenoptimierung, Fahrzeugverfolgung und Kundenbenachrichtigungen",
    ...
    },
    {
      ...
      solution:
        "Digitales Schulverwaltungssystem mit automatisierten Workflows",
      results: [
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Von der ersten Analyse bis zur erfolgreichen Umsetzung - sehen
                Sie konkrete Beispiele aus verschiedenen Branchen.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {useCases.map((useCase, index) => (
                <Card
                  key={index}
                  className="p-8 shadow-soft hover:shadow-card transition-smooth bg-background"
                >
                  {/* Header */}
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Lassen Sie uns gemeinsam analysieren, welche Automatisierungs-
                und KI-Potenziale in Ihrem Unternehmen schlummern. Kostenloses
                Erstgespräch, konkrete Roadmap, messbare Ergebnisse.
              </p>
