...
const Blog = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Entdecke, wie du 5 akute Herausforderungen meistern und nachhaltig wachsen kannst. Von der Strategie bis zur Umsetzung - Dein Digitalisierungs- und KI Berater.",
      generalCategory: "Prozessautomatisierung",
      industryCategory: "Immobilienverwaltung",
      author: "PAXUP Team",
      date: "22. März 2024",
      readTime: "10 Min.",
      image: "/src/assets/blog-bild.jpg",
      featured: true,
    },
    {
      id: 5,
  ...
  const kiPraxisPosts = [
    {
      ...
      excerpt:
        "Wie Unternehmen intelligente Chatbots erfolgreich einsetzen und dabei die Kundenzufriedenheit steigern.",
    ...
    },
    {
      id: 102,
      title:
        "Predictive Analytics in der Logistik: Effizienz durch Vorhersagen",
      excerpt:
        "Datengetriebene Prognosen revolutionieren die Lieferkette und reduzieren Kosten um bis zu 25%.",
    ...
    },
    {
      ...
      excerpt:
        "Automatisierte Fehlererkennung in der Produktion steigert Qualität und senkt Ausschuss.",
    ...
    },
    {
      id: 104,
      title:
        "KI-gestützte Personalauswahl: Objektiver und effizienter rekrutieren",
      excerpt:
        "Wie intelligente Systeme bei der Kandidatenauswahl helfen und Bias reduzieren.",
  ...
  const allgemeinPosts = [
    {
      ...
      excerpt:
        "Grundlagen, Begriffe und praktische Anwendungen von KI einfach erklärt.",
    ...
    },
    {
      ...
      excerpt:
        "Warum die Begriffe nicht synonym sind und was das für Ihr Unternehmen bedeutet.",
    ...
    },
    {
      ...
      excerpt:
        "Aufklärung über weit verbreitete Irrtümer und realistische Erwartungen an KI-Technologie.",
    ...
    },
    {
      ...
      excerpt:
        "DSGVO-konforme Implementierung von KI-Systemen und rechtliche Fallstricke.",
  ...
  const filteredPosts = blogPosts.filter((post) => {
    ...
    const matchesGeneralCategory =
      selectedGeneralCategory === "Alle" ||
      post.generalCategory === selectedGeneralCategory;
    const matchesIndustryCategory =
      selectedIndustryCategory === "Alle" ||
      post.industryCategory === selectedIndustryCategory;
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-base text-muted-foreground mb-6 max-w-xl mx-auto">
                  Erstklassige Inhalte, die Ihnen helfen, Ihre
                  Digitalisierungsbemühungen zu verbessern
                </p>
                      ...
                      <div className="mb-16">
                        <div className="mb-8">
                          ...
                          <p className="text-muted-foreground">
                            Unser Highlight für Sie besonders relevant und
                            aktuell
                          </p>
                        ...
                        <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 border-0 bg-gradient-subtle">
                          <div className="grid md:grid-cols-2 gap-0">
                            ...
                            <CardContent className="p-8 lg:p-12 flex flex-col justify-center">
                              <Badge
                                variant="secondary"
                                className="mb-4 w-fit bg-primary/10 text-primary border-primary/20"
                              >
                  ...
                  <div className="mb-16">
                    <div className="flex items-center justify-between mb-8">
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Die neuesten Beiträge zu Digitalisierung und KI
                        </p>
                        <Separator className="mt-4" />
                      </div>
                    ...
                    {filteredPosts.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-muted-foreground mb-6">
                          Versuchen Sie einen anderen Suchbegriff oder wählen
                      ...
                      <div className="space-y-16">
                        ...
                        <div>
                          <div className="mb-8">
                            ...
                            <p className="text-muted-foreground">
                              Branchenübergreifende Anwendungen und
                              Erfolgsgeschichten
                            </p>
                            <Separator className="mt-4" />
                          </div>
                        ...
                        <div>
                          <div className="mb-8">
                            <h2 className="text-3xl font-bold text-foreground mb-2">
                              Allgemeines zu KI & Digitalisierung im Mittelstand
                            </h2>
                            <p className="text-muted-foreground">
                              Grundlagen, Trends und Zukunftsperspektiven
                            </p>
                            <Separator className="mt-4" />
                          </div>
                          <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <Card className="bg-gradient-subtle border-primary/20">
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                          Erhalten Sie die neuesten Artikel direkt in Ihr
                          Postfach.
                        </p>
                        <div className="space-y-3">
                          <Input
