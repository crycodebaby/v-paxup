  ...
  const processSteps = [
    {
      ...
      description: "Wir analysieren Ihr Unternehmen ganzheitlich – von den Geschäftsprozessen über die IT-Landschaft bis hin zu den Arbeitsabläufen Ihrer Teams.",
      features: [
    ...
    },
    {
      ...
      description: "Basierend auf der Analyse ermitteln wir systematisch Ihre Stärken, decken Schwächen auf und leiten konkrete Digitalisierungspotenziale ab.",
      features: [
    ...
    },
    {
      ...
      description: "Wir entwickeln einen präzisen Umsetzungsplan mit drei Phasen, der Ihnen schrittweise und planbar zur digitalen Transformation verhilft.",
      features: [
    ...
    },
    {
      ...
      description: "Unser spezialisiertes Entwicklerteam setzt die geplanten Maßnahmen professionell um und begleitet Sie während der gesamten Transformation.",
      features: [
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                Wir entwickeln maßgeschneiderte Digitalisierungsstrategien unter Nutzung von KI und 
                Automatisierung. Unser bewährter 4-Stufen-Prozess führt Sie planbar und messbar 
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Das ist unser USP: Systematische Herangehensweise mit klaren Phasen, 
                messbaren Ergebnissen und garantiertem Erfolg.
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Detaillierte Einblicke in unseren bewährten Prozess und was Sie in 
                jeder Phase erwarten können.
              </p>
            </div>
                ...
                <div key={index} className="bg-background rounded-2xl p-8 lg:p-12 shadow-card">
                  <div className="grid lg:grid-cols-2 gap-12 items-start">
                    <div>
                      ...
                      <h4 className="text-xl font-bold mb-4">Was wir für Sie tun:</h4>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Lassen Sie uns Ihr Unternehmen analysieren und eine maßgeschneiderte 
                Digitalisierungsstrategie entwickeln. Unser bewährter Prozess garantiert messbaren Erfolg.
              </p>
