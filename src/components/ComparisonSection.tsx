import { X, Check, Clock, Shield, TrendingUp, Settings, Link, Target } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Während andere im KI-Chaos versinken, führen wir Sie sicher zum Erfolg
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="p-8 border-destructive/20 bg-destructive/5 animate-scale-in">
              ...
              <div className="space-y-6">
                {comparisonData.map((item, index) => (
                  <div key={`without-${index}`} className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">{item.without}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* With PAXUP Column */}
            <Card className="p-8 border-primary/20 bg-primary/5 animate-scale-in" style={{animationDelay: '0.2s'}}>
              <div className="text-center mb-8">
              ...
              <div className="space-y-6">
                {comparisonData.map((item, index) => (
                  <div key={`with-${index}`} className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-1">{item.title}</h4>
                      <p className="text-muted-foreground text-sm">{item.with}</p>
                    </div>
                  </div>
                ))}
              </div>
