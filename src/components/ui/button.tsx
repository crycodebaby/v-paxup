...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary-hover shadow-button transition-smooth",
        destructive:
        ...
        cta:
          ...
          "transform hover:-translate-y-0.5 transition-smooth font-semibold " +
          "focus-visible:ring-[hsl(var(--secondary))] dark:focus-visible:ring-[hsl(var(--primary))]",

        accent:
          "bg-accent text-accent-foreground hover:bg-accent-hover shadow-button transition-smooth",
      },
      size: {
